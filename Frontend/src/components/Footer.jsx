    ...
    <footer className="bg-gray-800 text-white pt-10 pb-5">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">SellerList Shop</h3>
            <p className="text-gray-300 mb-4">
              Your one-stop marketplace for quality products from verified sellers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=home" className="text-gray-300 hover:text-white">Home & Garden</Link>
              </li>
              <li>
                <Link to="/products?category=beauty" className="text-gray-300 hover:text-white">Beauty & Health</Link>
              </li>
              <li>
                <Link to="/products?category=sports" className="text-gray-300 hover:text-white">Sports & Outdoors</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} SellerList Shop. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
