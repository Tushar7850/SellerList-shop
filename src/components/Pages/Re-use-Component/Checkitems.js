          ...
          <div className="w-full mt-5 lg:ml-10  text-zinc-600 ">
            ...
            <div>
              ...
              <h2 className="text-lg mt-2">
                {" "}
                MRP:<span className="line-through ">{ selectedProduct.old_price ? selectedProduct.old_price :null}</span>
                {" "}
              </h2>

              <h2 className="text-red-600 mt-2 ">{selectedProduct.Stock}</h2>
              <div class="flex items-center">
              <Rating name="read-only" sx={{fontSize:"0.8rem"}} value={selectedProduct.rating} readOnly />
          <span class="  rounded bg-yellow-200 px-2 py-0.5 text-[0.7rem] font-semibold">{selectedProduct.rating}</span>
        </div>
            ...
            <div className="mt-2">
              ...
              <div for="Pincode" className="bg-white border rounded-lg pl-5  lg:w-2/3 flex justify-between mt-2 hover:border-blue-500  lg:mt-4  ">
                <input
                  type="text"
                  placeholder="Pincode"
