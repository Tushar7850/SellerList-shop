...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section className="grid place-content-center grid-cols-2 md:grid-cols-4 md:px-5 my-5 md:my-10 cursor-pointer sm:gap-4">
        <Feature
      ...
      <div className="w-full max-w-screen-xl   md:hidden ">
        <SimpleImageSlider
          width={"100%"}
          height={110}
          images={images}
...
function Feature({ icon, title, description }) {
  return (
    <div className="w-full p-2 md:p-4  hover:shadow-md ">
